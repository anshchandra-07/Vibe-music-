...
const MusicPlayer = ({ onToggleQueue, onToggleStations, isFullscreen, onToggleFullscreen }) => {
  ...
  return (
    <div className="w-full glass-panel glass-panel-glow rounded-2xl p-3 sm:p-5 flex flex-col gap-1.5 sm:gap-2 relative shadow-2xl">
      
      {/* 1. Track Metadata Section (Mobile View Header) */}
      <div className="flex items-center justify-between md:hidden w-full mb-1">
        <div className="flex flex-col min-w-0 pr-3">
          <h3 className="text-sm font-semibold text-white truncate glow-text-soft">
      ...
      <div className="flex items-center justify-between mt-1 gap-2 sm:gap-4">
